                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form action="<?php $_SERVER['PHP_SELF'];?>" method="POST">
                            <input type="text" id="campo" name="campo" placeholder="Busqueda"/>
			            ...
			            <div class="row table-responsive">
					        ...
					        <tbody>
                                ...
                                <td><a href="modificarusuario.php?id=<?php echo $row['id']; ?>"><span class="fas fa-fw fa-pen"></span></a></td>
								<td><a href="#" data-href="eliminarusuario.php?id=<?php echo $row['id']; ?>" data-toggle="modal" data-target="#confirm-delete"><span class="fas fa-fw fa-trash"></span></a></td>
							    </tr>
						        <?php } ?>
					        </tbody>
				            </table>
