<?php
	...
	$sql = "SELECT * FROM tarjetahabiente WHERE cod_cli = '$cod_cli'";
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="finalizado">Finalizado</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" method="POST" action="updatecliente.php" autocomplete="off">
                                
                                <div class="form-group">
                                    <label for="cod_cli" class="col-sm-2 control-label">Código del cliente</label>
                                    <div class="col-sm-6">
                                        <input type="int" class="form-control" id="cod_cli" name="cod_cli" placeholder="Código del cliente" value="<?php echo $row['cod_cli']; ?>" required >
                                    </div>                               
                                 </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="apellido" name="apellido" placeholder="Apellidos" value="<?php echo $row['apellido']; ?>" required >
                                    </div>                               
                                 </div>

                                 <div class="form-group">
                                    <label for="tipo_doc" class="col-sm-2 control-label">Tipo de documento de identidad</label>
                                    <div class="col-sm-6">
                                        <select class="form-control" id="tipo_doc" name="tipo_doc">
                                            <option value="carnet de identidad" <?php if ($row['tipo_doc']=='carnet de identidad') echo 'selected'; ?>>Carnet de identidad</option>
                                            <option value="carnet de extranjero" <?php if ($row['tipo_doc']=='carnet de extranjero') echo 'selected'; ?>>Carnet de extranjero</option>
                                 ...
                                 <div class="form-group">
                                    <label for="num_doc" class="col-sm-2 control-label">Numero del documento de identidad</label>
                                    <div class="col-sm-6">
                                        <input type="value" class="form-control" id="num_doc" name="num_doc" placeholder="Numero del documento" value="<?php echo $row['num_doc']; ?>" required >
                                    </div>                               
                                 </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="value" class="form-control" id="telefono" name="telefono" placeholder="Telefono" value="<?php echo $row['telefono']; ?>" required >
                                    </div>                               
                                 </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="email" name="email" placeholder="Correo electrónico" value="<?php echo $row['email']; ?>" required >
                                    </div>                               
                                 </div>
