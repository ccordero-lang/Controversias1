            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" method="POST" action="updateusuario.php" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" id="tipo_usuario" name="tipo_usuario">
                                            <option value="1" <?php if ($row['tipo_usuario']=='1') echo 'selected'; ?>>1</option>
                                            <option value="2" <?php if ($row['tipo_usuario']=='2') echo 'selected'; ?>>2</option>
                                        </select>
                                    </div>                               
                                 </div>
