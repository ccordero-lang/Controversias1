<?php
	...
	$sql = "SELECT * FROM tarjetahabiente $where";
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form action="<?php $_SERVER['PHP_SELF'];?>" method="POST">
                            <input type="text" id="campo" name="campo" placeholder="Busqueda por apellido"/>
                        ...
                        <?php if(!empty($valor)) { ?>
					        <tbody>
								...
								<td><a href="modificarcliente.php?cod_cli=<?php echo $row['cod_cli']; ?>"><span class="fas fa-fw fa-pen"></span></a></td>
								<td><a href="#" data-href="eliminarcliente.php?cod_cli=<?php echo $row['cod_cli']; ?>" data-toggle="modal" data-target="#confirm-delete"><span class="fas fa-fw fa-trash"></span></a></td>
							    </tr>
						        <?php } ?>
					        </tbody>
				            </table>
