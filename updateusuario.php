<?php
    ...
    $sql = "UPDATE usuarios SET usuario='$usuario', password='$password', nombre='$nombre', tipo_usuario='$tipo_usuario' WHERE id='$id'";
            ...
            <div id="content">
                ...
                <div class = "form group">
                    <div class = "col-sm-offset-2 col-sm-10" style="text-align:center">
                        ...
                        <?php } ?>
                        <a href="adicionar.php" class="btn btn-primary">Regresar</a>
                    </div>
                </div>
                </div>
</body>
