<?php
    ...
    $sql = "INSERT INTO tarjetahabiente (cod_cli, nombre, apellido, tipo_doc,  num_doc, direccion, telefono,  email)
    VALUES ('$cod_cli', '$nombre', '$apellido', '$tipo_doc', '$num_doc', '$direccion', '$telefono',  '$email')";
            ...
            <div id="content">
                ...
                <div class = "form group">
                    <div class = "col-sm-offset-2 col-sm-10" style="text-align:center">
                        ...
                        <?php } ?>
                        <a href="nuevocliente.php" class="btn btn-primary">Regresar</a>
                    </div>
                </div>
                </div>
</body>
