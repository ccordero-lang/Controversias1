<?php
    ...
    $sql = "UPDATE tarjetahabiente SET nombre='$nombre', apellido='$apellido', tipo_doc='$tipo_doc', num_doc='$num_doc', direccion='$direccion', 
    telefono='$telefono', email='$email' WHERE cod_cli='$cod_cli'";
