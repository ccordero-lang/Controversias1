<?php
    ...
    $sql = "UPDATE controversias SET flujo='$flujo', cod_cli ='$cod_cli', nombre_cliente='$nombre_cliente', departamento='$departamento', nombre_creador='$nombre_creador', numero_tarjeta='$numero_tarjeta', comercio='$comercio', 
    num_transaccion='$num_transaccion', monto_disputa='$monto_disputa', moneda='$moneda', fecha_confirmacion='$fecha_confirmacion', fecha_finalizacion='$fecha_finalizacion', estado='$estado', cite='$cite' , detalle='$detalle' WHERE id='$id'";
    ...
    if(in_array($_FILES["archivo"]["type"], $permitidos) && $_FILES["archivo"]["size"] <= $limite_kb*1024){
       ...
       if(!file_exists($archivo)){
            ...
            if($resultado){
                ...
                $mensaje = "ERROR AL MODIFICAR ARCHIVO";
            }
        ...
        $mensaje = "ARCHIVO NO PERMITIDO O EXCEDE EL TAMAÑO";
    }
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="en_atencion">En atención</a>
            ...
            <div id="content">
                ...
                <div class = "form group">
                    ...
                    <?php if ($resultado){?> 
                        ...
                        <?php } ?>
                        <a href="editar.php" class="btn btn-primary">Regresar</a>
                    </div>
                </div>
                </div>
</body>
